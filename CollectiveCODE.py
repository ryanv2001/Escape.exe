...
for i in range(3):
	...
	def shuffler():
	    ...
	    hackingterms = ['phishing','malware','ransomware','encryption','rootkit', 'firewall', 'payload']
	...
	def answer():
		...
		print('Congratulations on unscrambling the word! You may now move onto the next level!\n')
            	root.destroy()
	    else:
